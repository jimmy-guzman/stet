...
The mark beside a file fades as the change ages, so the brightest one is the
newest.

![The repository tree marking three just-changed files, each dot dimmer as its change ages](/screenshots/recent-activity.png)
