...
| `y`           | copy path (tree), path:line:col (viewer), or the selected search result | `copy-reference`                 |
| `Y`           | copy the entire contents of the viewed file                             | `copy-file`                      |
